...
Minimog_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-03.header-dark .mini-cart .mini-cart-icon:after',
			'property' => 'color',
		),
		array(
			'choice'   => 'background',
...
Minimog_Kirki::add_field( 'theme', array(
	...
	'output'          => Minimog_Header::instance()->get_search_form_kirki_output( '03', 'dark', false ),
...
Minimog_Kirki::add_field( 'theme', array(
	...
	'output'          => Minimog_Header::instance()->get_search_form_kirki_output( '03', 'dark', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'search_enable',
			'operator' => '==',
...
Minimog_Kirki::add_field( 'theme', array(
	...
	'output'          => Minimog_Header::instance()->get_button_kirki_output( '03', 'dark', false ),
	'active_callback' => array(
		array(
...
Minimog_Kirki::add_field( 'theme', array(
	...
	'output'          => Minimog_Header::instance()->get_button_kirki_output( '03', 'dark', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'dark_button_color',
			'operator' => '==',
...
Minimog_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-03.header-light .mini-cart .mini-cart-icon:after',
			'property' => 'color',
		),
		array(
			'choice'   => 'background',
...
Minimog_Kirki::add_field( 'theme', array(
	...
	'output'          => Minimog_Header::instance()->get_search_form_kirki_output( '03', 'light', false ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'search_enable',
			'operator' => '==',
...
Minimog_Kirki::add_field( 'theme', array(
	...
	'output'          => Minimog_Header::instance()->get_search_form_kirki_output( '03', 'light', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'search_enable',
			'operator' => '==',
...
Minimog_Kirki::add_field( 'theme', array(
	...
	'output'          => Minimog_Header::instance()->get_button_kirki_output( '03', 'light', false ),
	'active_callback' => array(
		array(
...
Minimog_Kirki::add_field( 'theme', array(
	...
	'output'          => Minimog_Header::instance()->get_button_kirki_output( '03', 'light', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'light_button_color',
			'operator' => '==',
