			...
			<?php if ( is_cart() ) : ?>
				<p class="woocommerce-shipping-destination">
					...
					if ( $formatted_destination ) {
						...
						printf( esc_html__( 'Shipping to %s.', 'minimog' ) . ' ', '<strong>' . esc_html( $formatted_destination ) . '</strong>' );
						$calculator_text = esc_html__( 'Change address', 'minimog' );
					} else {
						echo wp_kses_post( apply_filters( 'woocommerce_shipping_estimate_html', __( 'Shipping options will be updated during checkout.', 'minimog' ) ) );
					}
					?>
				</p>
			<?php endif; ?>
