...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
	...
	<h2><?php esc_html_e( 'Cart totals', 'minimog' ); ?></h2>

	<table cellspacing="0" class="shop_table shop_table_responsive">

		<tr class="cart-subtotal">
			<th><?php esc_html_e( 'Subtotal', 'minimog' ); ?></th>
			<td data-title="<?php esc_attr_e( 'Subtotal', 'minimog' ); ?>"><?php wc_cart_totals_subtotal_html(); ?></td>
		</tr>
		...
		<?php if ( WC()->cart->needs_shipping() && WC()->cart->show_shipping() ) : ?>
			<tr class="cart-shipping">
				<th><?php esc_html_e( 'Shipping', 'minimog' ); ?></th>
				<td>
		...
		<tr class="order-total">
			<th><?php esc_html_e( 'Total', 'minimog' ); ?></th>
			<td data-title="<?php esc_attr_e( 'Total', 'minimog' ); ?>"><?php wc_cart_totals_order_total_html(); ?></td>
		</tr>
