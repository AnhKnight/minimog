		...
		<div class="product-thumbnail">
			...
			<div class="product-actions">
				<div class="product-action-block">
					...
					?>
					<div class="product-action product-action--quickview compare-btn hint--bounce hint--top hint--primary" aria-label="Quick Shop">
						<?php
					...
					<?php
					Minimog_Woo::instance()->get_wishlist_button_template( $button_settings );
					?>
				</div>
